source "qemu" "harmonic-installer" {
  ...
  # output_directory = "output-${var.vm_name}/${var.vm_name}"
  ...
  qemuargs = [
    ...
    ["-drive", "file=${path.root}/seeds.iso,format=raw,cache=none,if=none,id=drive1,readonly=on"],
